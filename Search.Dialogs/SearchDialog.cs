namespace Search.Dialogs
{
    ...
    public abstract class SearchDialog : IDialog<IList<SearchHit>>
    {
            ...
            else
            {
                ...
                else
                {
                    ...
                    await context.PostAsync(
                        ...
                        "You can select one, **refine** these results, see **more**, search **again**, or are you **done**?.");
        ...
        {
            SearchHit hit = this.found.SingleOrDefault(h => h.Id == selection);
            if (hit == null)
            {
            ...
            {
                if (!this.selected.Any(h => h.Id == hit.Id))
                {
